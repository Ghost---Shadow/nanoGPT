"""
Same as data/mnist_jpeg/prepare.py, but using 4x4 pixel blocks (instead of
8x8) so the image is divided into 64 blocks (8x8 grid) instead of 16 --
a squarer, higher-resolution version of the 32-block (4x8) experiment.
Reuses jpeg_encode.py from the sibling mnist_jpeg/ dataset dir rather than
